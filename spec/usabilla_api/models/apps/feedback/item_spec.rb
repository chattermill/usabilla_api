      ...
      module Feedback
        describe Data do
          ...
          context 'a apps feedback_hash is valid' do
            let(:geo_location_hash) { { 'lat' => 2, 'lon' => 3 } }
            let(:data_hash) { { 'mood' => 1, 'comment' => 'I like it' } }
            ...
            it { expect(feedback.geo_location).to eq(geo_location_hash) }
